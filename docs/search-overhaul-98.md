...
4. Bulk suggestion selection (98 §11 "carefully designed bulk selection") remains per-term by design: 97.md explicitly removed the one-click bundle after review; re-introducing checkbox multi-select is documented as a product decision, not silently shipped.
