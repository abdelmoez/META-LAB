    ...
    <div>
      ...
      <Card>
        ...
        <div style={{ borderTop: `1px solid ${C.brd}`, marginTop: 14, paddingTop: 14 }}>
          <Row title="Restrict chat" hint="When on, only the project owner can post — everyone else, including leaders, is read-only. Mute an individual member instead with their Chat permission.">
            {canManage
